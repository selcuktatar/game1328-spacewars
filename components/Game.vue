<template>
    <div id="game">
        ...
        <p>{{ bombStateText }}</p>
        <minefield :minefield="minefield" @onCellLeftClicked="onCellClicked" @onCellRightClicked="onCellFlagged"></minefield>
        <button-switch id="mine-mode-switch" @onSelected="onModeChanged"></button-switch>
    </div>
</template>
